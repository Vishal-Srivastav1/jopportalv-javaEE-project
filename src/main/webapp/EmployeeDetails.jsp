	...
	<div class="container ">
		<div class="row ">
			<div class="col-md-10 sm">
				<h5 class="text-center text-primary">Employee Details</h5>
				...
				List <Applyjobuser> list=dao.AllEmployeeDetails();
				...
				<div class="card mt-2 main">
					...
					<h6 class="rk">Employee Details: <%=count %></h6>
					</div>
					...
					<tbody>
								...
								<tr>
									...
									<th>
									 ...
									 <a href="mailto:<%=j.getEmail() %>"><%=j.getEmail() %></a> 
									</th>
								</tr>
